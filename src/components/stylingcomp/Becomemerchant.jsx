...
<div className='h-screen w-full relative overflow-x-hidden'>
      ...
      <div className='absolute top-56 text-white h-[400px] md:w-[750px] w-auto md:px-20 px-5 z-10'>
        <h1 className='leading-[1.5] font-sans md:text-[50px] whitespace-nowrap  text-[28px] font-bold w-full max-w-[300px] md:max-w-full break-words'>
        Become A Merchant
        </h1>
        <h1
    ...
    <button className='h-10 my-4 w-[220px] rounded-3xl border-2 border-orange-300 hover:bg-orange-300 bg-black text-white font-sans text-[16px] md:text-[17px] font-semibold md:mx-0 mx-8'>
  ...
  <div className="lg:px-6 md:py-10 lg:py-32 py-2  px-2 flex-1 md:px-10">
...
Start Now
    ...
    <div className='grid md:grid-cols-3 md:translate-x-[-10x] translate-x-[-10px] px-0   flex-1 lg:py-32 md:py-7 md:mx-10 py-0 md:space-y-0 space-y-14 '>
  <div className='md:col-span-1 col-span-3 h-auto w-auto md:mx-0 mx-8'>
    ...
    <span>
    <h3 className='font-bold font-sans text-[21px] text-white my-2 md:text-start lg:text-start text-center md:mx-0'>Signup</h3>
    </span>
    <span>
 <h3 className='my-2 text-[14px] text-gray-400 lg:w-60 md:w-[350px] md:text-start text-center'>
 Simply Signup With Us A Merchant, After Signing Up And Completing Your Business Details With Us You Can Move To The Next Step!
  ...
  <div className='md:col-span-1 col-span-3 h-auto w-auto md:mx-40 lg:mx-20 mx-8 '>
    ...
    <span>
    <h3 className='font-bold whitespace-nowrap font-sans text-[21px] text-white my-2  md:text-start lg:text-start text-center  md:mx-0 '>Discuss Your Product</h3>
    </span>
    <span>
 <h3 className='my-2 text-[14px] text-gray-400 lg:w-60 md:text-start text-center md:w-[350px]'>
 After Signing Up You Can Send Product For Review Our Team Will Review Your Product And Will Confirm Either We Can List Your Product Or Not
  ...
  <div className='md:col-span-3 col-span-3 h-auto w-auto md:mx-0 mx-8 md:py-9 py-0'>
    ...
    <span>
    <h3 className='font-bold font-sans text-[21px] text-white my-2 whitespace-nowrap md:text-start lg:text-start text-center  md:mx-0'>Win Sales By Our Affiliate</h3>
    </span>
    <span>
 <h3 className='my-2 text-[14px] md:text-[16px]  text-gray-400 lg:w-60 md:text-start text-center md:w-[350px] '>
 Now Our Affiliates Will Choose Your Product And Can Sell Those ,You Can Earn!
  ...
  <div className='w-full h-1 bg-slate-300 px-8'></div>
   </>
  )
}
